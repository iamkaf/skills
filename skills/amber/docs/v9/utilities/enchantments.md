...
::: warning Deprecated
The `EnchantmentUtils` class is **deprecated** and will be removed in Amber 10.0.

Use `com.iamkaf.amber.api.functions.v1.ItemFunctions` instead. See [Functions API → ItemFunctions → Enchantment Operations](functions/item#enchantment-operations) for the new API.
:::
