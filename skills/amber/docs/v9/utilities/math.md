...
::: warning Deprecated
The `Chance` class is **deprecated** and will be removed in Amber 10.0.

Use `com.iamkaf.amber.api.functions.v1.MathFunctions` instead. See [Functions API → MathFunctions](functions/math) for the new API.
:::
