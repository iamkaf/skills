...
This guide covers best practices for developing mods with Amber, including code organization, performance optimization, security considerations, and maintainability tips.

## Code Organization

### 1. Package Structure

Organize your code with a clear package structure:
...
│   │   └── CustomItem.java # Custom item implementation
...
└── neoforge/               # NeoForge-specific code
    └── MyModNeoForge.java  # NeoForge entry point
```
...
public final class ModVersion {
    private ModVersion() {} // Prevent instantiation
    ...
    public static boolean isCompatible(String version) {
        ...
        // Compatible if same major version and minor version is not greater
...
public class ConfigMigration {
    public static MyModConfig migrateConfig(OldConfig oldConfig) {
        MyModConfig newConfig = new MyModConfig();
        
        // Migrate common fields
        newConfig.enableFeature = oldConfig.enableFeature;
        newConfig.maxEnergy = oldConfig.maxEnergy;
        
        // Handle renamed fields
        newConfig.energyMultiplier = oldConfig.transferRate; // Renamed
        
        // Handle new fields with defaults
        newConfig.enableAdvancedFeatures = true; // New field
...
Following these best practices will help you create mods that are:

- **Maintainable**: Easy to understand and modify
- **Performant**: Efficient and optimized
- **Secure**: Robust against common issues
- **Reliable**: Consistent behavior across platforms
- **Future-Proof**: Ready for new versions and features

Remember that the most important practice is to keep learning and improving your code as you gain experience with Minecraft modding and Amber.