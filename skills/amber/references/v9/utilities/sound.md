...
::: warning Deprecated
The `SoundHelper` class is **deprecated** and will be removed in Amber 10.0.

- For player-directed sounds, use `com.iamkaf.amber.api.functions.v1.PlayerFunctions.playSound()`
- For position-based sounds, use `com.iamkaf.amber.api.functions.v1.WorldFunctions.playSoundAt()`

See [Functions API → PlayerFunctions](functions/player) or [Functions API → WorldFunctions](functions/world) for the new API.
:::
